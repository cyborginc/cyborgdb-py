...
class IndexIVFPQModel(BaseModel):
    """
    ...
    type: Optional[StrictStr] = 'ivfpq'
    pq_dim: StrictInt
    pq_bits: StrictInt
    __properties: ClassVar[List[str]] = ["dimension", "type", "pq_dim", "pq_bits"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type") if obj.get("type") is not None else 'ivfpq',
            "pq_dim": obj.get("pq_dim"),
            "pq_bits": obj.get("pq_bits")
        })
        return _obj
