...
class BinaryQueryRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["text", "text_fields", "text_field_weights", "require_all_terms", "alpha", "rrf_k", "window_mult", "index_name", "index_key", "batch", "top_k", "n_probes", "rerank_mult", "greedy", "filters", "include"]
