...
class UpsertRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["index_name", "index_key", "items"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [VectorItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
