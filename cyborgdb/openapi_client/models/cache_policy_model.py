...
class CachePolicyModel(BaseModel):
    """
    Per-keystore RAM caching policy. Each field opts a keystore into the in-memory cache. Fields left as None fall back to cyborgdb-core's default (cache nothing).
    """ # noqa: E501
    vectors: Optional[StrictBool] = None
    metadata: Optional[StrictBool] = None
    ids: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["vectors", "metadata", "ids"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CachePolicyModel from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CachePolicyModel from a dict"""
        if obj is None:
            return None
